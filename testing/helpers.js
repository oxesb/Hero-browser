...
exports.createSession = exports.createScriptMeta = exports.onClose = exports.afterAll = exports.afterEach = exports.readableToBuffer = exports.getLogo = exports.getTlsConnection = exports.waitForElement = exports.httpGetWithSocket = exports.runHttp2Server = exports.http2Get = exports.httpGet = exports.getProxyAgent = exports.httpRequest = exports.runHttpServer = exports.runHttpsServer = exports.sslCerts = exports.runKoaServer = exports.needsClosing = void 0;
const Fs = require("fs");
...
async function http2Get(host, headers, sessionId, proxyUrl) {
    ...
    const socketSession = new MitmSocketSession_1.default(log, {
...
function getTlsConnection(serverPort, host = 'localhost', isWebsocket = false, proxyUrl) {
    const tlsConnection = new unblocked_agent_mitm_socket_1.default(`session${(sessionId += 1)}`, log, {
        host,
...
function createScriptMeta(module, id) {
    return {
...
exports.createScriptMeta = createScriptMeta;
async function createSession(options) {
    const connection = hero_core_1.default.addConnection();
