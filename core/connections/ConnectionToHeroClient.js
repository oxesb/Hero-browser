...
class ConnectionToHeroClient extends eventUtils_1.TypedEventEmitter {
    constructor(transport, autoShutdownMillis = -1) {
        super();
        this.transport = transport;
        this.autoShutdownMillis = autoShutdownMillis;
    ...
    async connect(options = {}) {
        ...
        await index_1.default.start(options);
        return {
            maxConcurrency: index_1.default.pool.maxConcurrentAgents,
        };
    }
    ...
    async createSession(options = {}) {
        ...
        clearTimeout(this.autoShutdownTimer);
        const { session, tab } = await Session_1.default.create(options);
