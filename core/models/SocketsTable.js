...
class SocketsTable extends SqliteTable_1.default {
    ...
    insert(record) {
        const { id, localAddress, remoteAddress, serverName, alpn, createTime, dnsLookupTime, ipcConnectionTime, dnsResolvedIp, connectTime, errorTime, connectError, closeTime, } = record;
