...
export declare type ICommandPresetMeta = Pick<ICoreCommandRequestPayload, 'startTime' | 'sendTime' | 'activeFlowHandlerId' | 'flowCommandId' | 'commandId' | 'callsite' | 'retryNumber'>;
