...
class CommandFormatter {
    static toString(command) {
        ...
        const args = TypeSerializer_1.default.parse(command.args).filter(x => x !== null);
    ...
    static parseResult(meta) {
        ...
        if (meta.result && meta.name === 'takeScreenshot') {
            ...
            const result = TypeSerializer_1.default.parse(meta.result);
