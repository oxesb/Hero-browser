...
class CoreTab {
    constructor(meta, connection, coreSession) {
        ...
        this.commandQueue = new CoreCommandQueue_1.default(this.meta, coreSession.mode, connection, coreSession);
        this.commandQueue.registerCommandRetryHandlerFn(this.shouldRetryFlowHandlers.bind(this));
        this.coreSession = coreSession;
        this.eventHeap = new CoreEventHeap_1.default(this.meta, connection, coreSession);
