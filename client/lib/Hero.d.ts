...
export declare type ISessionOptions = ISessionCreateOptions & Pick<IHeroCreateOptions, 'connectionToCore'>;
...
export default class Hero extends AwaitedEventTarget<{
    ...
    detach(elementOrResource: Resource | WebsocketResource | IDomExtensionClass): Promise<void>;
    close(): Promise<void>;
    ...
    triggerFlowHandlers(): Promise<void>;
    then<TResult1 = Hero, TResult2 = never>(onfulfilled?: ((value: Omit<Hero, 'then'>) => PromiseLike<TResult1> | TResult1) | undefined | null, onrejected?: ((reason: any) => PromiseLike<TResult2> | TResult2) | undefined | null): Promise<TResult1 | TResult2>;
    toJSON(): any;
}
export {};
