...
class Resource {
    ...
    $detach() {
        return __classPrivateFieldGet(this, _Resource_coreTabPromise, "f").then(x => x.detachResource(undefined, __classPrivateFieldGet(this, _Resource_resourceMeta, "f").id));
    }
