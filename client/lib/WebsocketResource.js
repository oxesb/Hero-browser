...
exports.createWebsocketResource = void 0;
...
class WebsocketResource extends AwaitedEventTarget_1.default {
    ...
    $detach() {
        return __classPrivateFieldGet(this, _WebsocketResource_coreTabPromise, "f").then(x => x.detachResource(undefined, __classPrivateFieldGet(this, _WebsocketResource_resourceMeta, "f").id));
    }
