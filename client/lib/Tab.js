...
var _Tab_instances, _Tab_hero, _Tab_mainFrameEnvironment, _Tab_frameEnvironments, _Tab_coreTabPromise, _Tab_coreTabOrReject_get, _Tab_getOrCreateFrameEnvironment, _Tab_getRefreshedFrameEnvironments;
Object.defineProperty(exports, "__esModule", { value: true });
exports.createTab = exports.getCoreTab = void 0;
...
class Tab extends AwaitedEventTarget_1.default {
    constructor(hero, coreTabPromise) {
        super(() => {
    ...
    get [(_Tab_hero = new WeakMap(), _Tab_mainFrameEnvironment = new WeakMap(), _Tab_frameEnvironments = new WeakMap(), _Tab_coreTabPromise = new WeakMap(), _Tab_instances = new WeakSet(), _Tab_coreTabOrReject_get = function _Tab_coreTabOrReject_get() {
    ...
    async validateState(state) {
        const callsitePath = internal_1.scriptInstance.getScriptCallsite();
        const coreTab = await __classPrivateFieldGet(this, _Tab_coreTabPromise, "f");
...
// CREATE
function createTab(hero, coreTab) {
