...
exports.createFrame = exports.getCoreFrameEnvironmentForPosition = void 0;
...
class FrameEnvironment {
    ...
    async xpathSelectorAll(xpath, orderedNodeResults = false) {
        const results = await this.document.evaluate(xpath, this.document, null, orderedNodeResults
            ? XPathResult_1.default.ORDERED_NODE_ITERATOR_TYPE
            : XPathResult_1.default.UNORDERED_NODE_ITERATOR_TYPE);
        const nodes = [];
        let node;
