...
export default class CoreSession extends TypedEventEmitter<{
    ...
    private commandId;
    private cliPromptMessage;
    private cliPrompt;
    private isClosing;
    private closingPromise;
    constructor(sessionMeta: ISessionMeta, connectionToCore: ConnectionToHeroCore, options: ISessionCreateOptions);
    ...
    private showSessionKeepAlivePrompt;
}
