...
export declare type IInteraction = ICommand | ICommandDetailed;
declare type IInteractions = IInteraction[];
...
export declare type ICommand = keyof typeof Command;
...
export declare type ITypeInteraction = string | IKeyboardKeyCode;
export declare type ISuperElementWithVerification = {
